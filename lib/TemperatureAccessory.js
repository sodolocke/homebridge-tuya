...
*/
    ...
    _registerCharacteristics(dps) {
        ...
        .updateValue(dps[this.dpCurrentTemperature]/100)
        .on('get', this.getState.bind(this, this.dpCurrentTemperature));


console.log("Temperature ID", this.dpCurrentTemperature);
console.log("dps", dps);
...
*/
        ...
        const characteristicCurrentHumidity = this.accessory.getService(Service.HumiditySensor)
            ...
            .updateValue(this._getCurrentHumidity(dps[this.dpCurrentHumidity]))
            .on('get', this.getState.bind(this, this.dpCurrentTemperature));
/*
