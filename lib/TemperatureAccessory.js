...
class TemperatureAccessory extends BaseAccessory {
    ...
    _registerCharacteristics(dps) {
        ...
        this.device.on('change', (changes, state) => {
            if (changes.hasOwnProperty(this.dpCurrentTemperature) && this.characteristicTemperature.hasOwnProperty('updateValue')) this.characteristicTemperature.updateValue(changes[this.dpCurrentTemperature]);

            if (changes.hasOwnProperty(this.dpCurrentHumidity) && this.characteristicCurrentHumidity.hasOwnProperty('updateValue')) this.characteristicCurrentHumidity.updateValue(changes[this.dpCurrentHumidity]);
        });
    }
}
