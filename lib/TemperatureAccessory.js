...
class TemperatureAccessory extends BaseAccessory {
    ...
    _registerCharacteristics(dps) {
        ...
        this.device.on('change', (changes, state) => {
            ...
            if (changes.hasOwnProperty(this.dpCurrentHumidity) && ypeof this.characteristicHumidity !== 'undefined') this.characteristicCurrentHumidity.updateValue(changes[this.dpCurrentHumidity]);
        });
    }
}
