...
if (changes.hasOwnProperty(this.dpCurrentTemperature) && this.characteristicCurrentTemperature.value !== changes[this.dpCurrentTemperature] ) {
    console.log(changes[this.dpCurrentTemperature]);

//    this.characteristicTemperature.updateValue(changes[this.dpCurrentTemperature]);
}



/*
            if (changes.hasOwnProperty(this.dpCurrentTemperature) && this.characteristicCurrentTemperature.value !== changes[this.dpCurrentTemperature] ) this.characteristicTemperature.updateValue(changes[this.dpCurrentTemperature]);

            if (changes.hasOwnProperty(this.dpCurrentHumidity) && this.characteristicCurrentHumidity.value !== changes[this.dpCurrentHumidity]) this.characteristicCurrentHumidity.updateValue(changes[this.dpCurrentHumidity]);
*/
        });
    }
}
